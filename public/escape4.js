...
var achieve=[
  ...
  {name:"七転八起",sub:"いずれかのモードで3回以上リトライしてクリアする"},
  {name:"トレジャーハンター",sub:"「クロンダイク」を15回クリアする"},
  {name:"スーパーソニック",sub:"「クロンダイク」を2分40秒以内にクリアする"},
  {name:"極地のクモ",sub:"「マグマンタ」を10回クリアする"},
  {name:"迅速の英雄",sub:"「マグマンタ」を3分以内にクリアする"},
  {name:"エリアノド守護者",sub:"「エリアノド防衛戦」を7回クリアする"},
...
const assembleA=new Array(1,2,3,4,7,8,9,11,12,13,16,17,28,37,48,59,61,64,65,67,68,72,74,78,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,121,122,123,124,125,126,127,128,129,130,131,132,133,135,143,144,145,146,147,148,149,154,155,156,158)
//戦闘
...
//各エリアごとで獲得可能なレシピ
const areaRecipe=[
  [7,8,84,96,119,120,101,147],
  [2,48,85,87,106,109,121,101,147],
    ...
    switch(R){
      ...
      case 8:
        if(UserLibrary.indexOf(1)!==-1){
          ...
          MsgAry.push(["狭間","……。",1])
          MsgAry.push(["リティア","……もしかして、寝てるんじゃあないでしょうね？"]);
          MsgAry.push(["狭間","……あ。いや？　そんなことないよ。",1])
          MsgAry.push(["リティア","ほんとぉ？"]);
        ...
        case 9:
          if(UserLibrary.indexOf(1)!==-1){
            MsgAry.push(["リティア","うーん……。&素材が集まらない～。&錬成のレシピが思いつかない～。",0,0,3,1]);
            MsgAry.push(["狭間","ヘニルの時空の採取は、&最初のトランプの色と連鎖数によって、&手に入る素材が変わるみたいだよ。",1])
        ...
        case 10:
          ...
          MsgAry.push(["リティア","ねぇ、そこに飾ってある意味ありげな額縁、&どう思う？",0,0,3,1]);
          MsgAry.push(["狭間","額縁自体に何か隠されているわけではなさそうだよね。&5つのパネルがあるけど、何だろう。",1])
          MsgAry.push(["リティア","マグマンタはトランプを5組使うから、&きっと何か関係があると思うのよ。"]);
          MsgAry.push(["狭間","となると気になるのはJ～Kの絵札だよね。",1])
          MsgAry.push(["リティア","絵札の模様とパネルを見比べてみようか。&……あ！"]);
          MsgAry.push(["狭間","なにか気づいた？",1])
          MsgAry.push(["リティア","マグマンタのソリティアで、&クリアの仕方をいろいろ試してみようか。"]);
          MsgAry.push(["end"]);
          MsgNext(-1);
          }
        break;
