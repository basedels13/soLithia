...
var itemA=[
  ...
  {name:"エルダー小麦",price:9,class:"植物資源",detail:"寒さに強い小麦。&種は挽いて粉にして使われる。&エルの樹の麓などで採れる。"},
  ...
  {name:"ナソードメモリー",price:87,class:"その他資源",detail:"ナソードに組み込まれていた&メモリーチップの部品。&アルテラ平原で採れる。"},
  ...
  {name:"ムーンストーン",price:54,class:"鉱物資源",detail:"暗所で紫色に光る壊れやすい石。&砂が固まってできたもの。&影の鉱脈で採れる。"},
  ...
  {name:"輝霜錬石",price:50,class:"鉱物資源",detail:"極北で採れる白い鉱石。&ディシオン採掘場でたまに採れる。"},
...
var henirarea=[
  ...
  {name:"ディシオン採掘場",Nitem:[[32],[58]],Ritem:[[13],[63]],SRitem:[[21],[65]],Monster:["プリンチュ","アルポコピュリタ","マナイーター"]},
